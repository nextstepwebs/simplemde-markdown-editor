# Note 
The original repository is down,
I create this mirror and fix some dependencies issus for some package rely on it  
[origin](https://github.com/nextstepwebs/simplemde-markdown-editor)
